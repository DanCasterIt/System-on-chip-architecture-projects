...
uint8_t TxBuffer_RouterName[] = "at+s.ssidtxt=TIM-22266499\n\r"; 										// TIM-22266499
uint8_t TxBuffer_RouterPW[] = "at+s.scfg=wifi_wpa_psk_text,qvB7IQ31dc1XIdK7FNZ56Hlm\n\r";	// qvB7IQ31dc1XIdK7FNZ56Hlm
